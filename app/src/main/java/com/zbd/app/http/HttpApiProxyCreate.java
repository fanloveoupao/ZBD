...
import static com.zbd.app.http.Config.COMMON_DATA_BASE_URL;
...
public class HttpApiProxyCreate {
    ...
    public static String getCheckClientVersionUrl(String version) {
        return COMMON_DATA_BASE_URL + "/Api/ClientVersion?os=0&version=" + version;
    }
    ...
    private <T> ApiConfig getConfig(Class<T> classOfT) {
            ...
            return new ApiConfig(COMMON_DATA_BASE_URL, 15, true, true);
    }
    ...
    private Retrofit createRetrofit(ApiConfig config, String baseUrl) {
        ...
        OkHttpClient.Builder httpBuilder = new OkHttpClient.Builder()
                ...
                .addInterceptor(new HttpLoggingInterceptor().setLevel(TgnetApplication.DEBUG ? HttpLoggingInterceptor.Level.BODY :
