package com.zbd.app.im.adapter;
...
import com.ysnet.im.presenter.presenter.FriendshipManagerPresenter;
import com.ysnet.im.ui.CircleImageView;
import com.zbd.app.R;
import com.zbd.app.im.model.FriendFuture;
...
public class FriendManageMessageAdapter extends ArrayAdapter<FriendFuture> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.avatar.setImageResource(R.mipmap.head_other);
