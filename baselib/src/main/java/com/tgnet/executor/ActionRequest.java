...
public class ActionRequest implements Runnable {
    ...
    public static class Builder {
        private final static String DEFAULT_LOADING_MESSAGE = "请稍后";

        private ActionRunnable runnable = null;
        private int handleOnExceptionType = HANDLE_ON_EXCEPTION_NONE;
        private String loadingMessage = DEFAULT_LOADING_MESSAGE;
        private int runType = RUN_TYPE_LOADING;
        private int backOnExceptionType = BACK_ON_EXCEPTION_TYPE_CLOSE;
