...
import com.ysnet.im.presenter.viewfeatures.GroupInfoView;
import com.ysnet.im.presenter.viewfeatures.GroupManageMessageView;
import com.ysnet.im.presenter.viewfeatures.GroupManageView;
...
public class GroupManagerPresenter {
     ...
     * @param key 关键字
     */
    public void searchGroupByName(final String key){
        long flag = 0;
