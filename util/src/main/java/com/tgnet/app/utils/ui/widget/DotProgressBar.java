...
public class DotProgressBar extends View {
    ...
    private void initializeAttributes(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                setStartColor(
                        a.getInteger(
                                ...
                                ContextCompat.getColor(getContext(), R.color.orange_ff9900)
                        )
                );
                setEndColor(
                        a.getInteger(
                                R.styleable.DotProgressBar_endColor,
                                ContextCompat.getColor(getContext(), R.color.orange_ff5500)
                        )
                );
            ...
            setStartColor(ContextCompat.getColor(getContext(), R.color.orange_ff5500));
            setEndColor(ContextCompat.getColor(getContext(), R.color.orange_ff9900));
