...
public class FileHelper {
    private final static String basePath = "tgnet";
    ...
    public static String saveImage(BaseActivity activity, String filename, Bitmap bitmap,boolean isToast) throws IOException {
        if (!activity.getRxPermissions().isGranted(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            activity.getRxPermissions().request( Manifest.permission.WRITE_EXTERNAL_STORAGE);
            return null;
        }
