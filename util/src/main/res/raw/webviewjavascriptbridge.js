;(function() {
	...
	/*	alert("sending:"+JSON.stringify(message.data))*/
		_WebViewJavascriptBridge._handleMessageFromJs(message.data?JSON.stringify(message.data):null,message.responseId||null,
	...
	function _dispatchMessageFromJava(messageJSON) {
			...
			var messageHandler
			console.log("message:"+message+"data:"+message.data+',handlerName:'+message.handlerName);
			if (message.responseId) {
				...
				if (message.handlerName) {
					...
					console.log("==messageHandlers=" + messageHandlers[message.handlerName])
				}
				try {
